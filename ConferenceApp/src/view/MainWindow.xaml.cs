...
namespace ConferenceApp.view
{
	public partial class MainWindow : Window
	{
		...
		public MainWindow(User user) : this() 
		{
			...
			Drawer_MenuListView.Items.Add(new ItemMenu("Sessions", PackIconKind.Connection, new UsersControl(loggedInUser)));
			Drawer_MenuListView.Items.Add(new ItemMenu("Events", PackIconKind.Connection, new UsersControl(loggedInUser)));
			Drawer_MenuListView.Items.Add(new ItemMenu("Menu Control", PackIconKind.About, new MenuControl()));
			Drawer_MenuListView.Items.Add(new ItemMenu("Users", PackIconKind.Connection, new UsersControl(loggedInUser)));
